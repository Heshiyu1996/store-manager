        ...
        <el-form ref="form" :model="form" label-width="110px">
            ...
            <el-form-item label="申请人员">
                <el-select v-model="form.applicantAccount" filterable placeholder="请选择申请人员">
                    <el-option v-for="item in otherList['staffList']" :key="item.id" :label="item.name" :value="item.id"> </el-option>
                </el-select>
            </el-form-item>
...
import { addMaterialExport, editMaterialItem, getOtherList } from '@/server/api'
...
export default {
    ...
    methods: {
        submit(e) {
            ...
            this.type ? this._addMaterialExport() : this._editMaterialItem()
        },
        _getOtherList() {
