<template>
    <u-layout class="key-list" direction="v">
        <div class="top-wrapper">
            <u-layout class="filter">
                ...
                <u-input v-model.trim="searchParams.name" maxLength="100" placeholder="请输入钥匙编号" searchIcon @key-press-enter="_getList" />
            </u-layout>
...
import { getKeyList, deleteKey, updateKeyStatus } from '@/server/api'
